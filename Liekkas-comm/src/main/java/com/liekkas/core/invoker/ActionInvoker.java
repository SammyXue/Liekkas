...
public class ActionInvoker {
    ...
    public Object invoke(StandardRequest request) {
        try {
            ...
            return genErrorResponse(e, request.getRequestId());
        }
    }

    public static Protocol.Response genErrorResponse(Exception e, String requestId) {
        ...
        if (e instanceof InvocationTargetException) {
            ...
            errMsg = ((ServiceException)e).getErrorMsg();
